...
class MOHKG:
    ...
    def _initialize_hardware_platforms(self):
        ...
        platforms = [
            HardwareNode(
                id="hw_a100",
                platform_name="NVIDIA A100 / CUDA-cuDNN",
                vendor="NVIDIA",
            ...
            HardwareNode(
                id="hw_ascend910b",
                platform_name="Huawei Ascend 910B / CANN",
                vendor="Huawei",
            ...
            HardwareNode(
                id="hw_mlu370x8",
                platform_name="Cambricon MLU370-X8 / BANG-CNNL",
                vendor="Cambricon",
                compute_capability="MLUv02",
            ...
            HardwareNode(
                id="hw_gpu_max1550",
                platform_name="Intel GPU Max 1550 / oneAPI",
                vendor="Intel",
                compute_capability="Xe-HPC",
                peak_flops_tflops=420.0,
            ...
            HardwareNode(
                id="hw_xeon8380",
                platform_name="Intel Xeon 8380 / oneDNN",
                vendor="Intel",
                compute_capability="Ice Lake",
                peak_flops_tflops=3.0,
                memory_bandwidth_gbps=204.0,
                memory_size_gb=512.0,
                supported_dtypes=["FP32", "BF16", "INT8"],
            ),
        ]
